...
function sortnumber(n) {
  ...
  while (switching) {
                            ...
                            <div class="search-element mr-2">
								<input class="form-control" type="search" placeholder="Search" aria-label="Search"  name="Search" id="Search" >
												...
												<table class="table table-bordered mb-0 text-nowrap" id="myTable">
													<tr class="bg-primary">
														<th  onclick="sortnumber(0)">numOrd</th>
														<th  onclick="sortTable(1)">nomDoc</th>
														<th onclick="sortTable(2)">maladie</th>
														<th  onclick="sortTable(3)">dateCon</th>
	...
	<td><a  href= "../ord/<?PHP echo $row['url']; ?>"> ordonnance </a></td>
